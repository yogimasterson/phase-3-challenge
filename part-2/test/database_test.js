...
describe('itemsInSection()', function() {
	it('should find the IDs and names of all grocery items in the given section', function() {
...
describe('cheapItems()', function() {
	it('should find the IDs and prices of all grocery items that cost less than $10.00, ordered from lowest to highest price', function() {
...
describe('countItemsInSection()', function() {
	it('should get the count of all grocery items in the given section', function() {
